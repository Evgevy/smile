...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initAccord: function() { return /* binding */ initAccord; }
/* harmony export */ });
var initAccord = function initAccord() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initDare: function() { return /* binding */ initDare; }
/* harmony export */ });
var initDare = function initDare() {
  ...
  var selectedDateDiv = document.getElementById('selected-date');
  var selectedDate = null;
  var currentDate = new Date();
  if (calendarGrid) {
    var renderCalendar = function renderCalendar(date) {
      calendarGrid.querySelectorAll('.day').forEach(function (day) {
        return day.remove();
      });
      ...
      // Первый день месяца (номер дня недели 0-6, где 0 - воскресенье)
      var firstDay = new Date(year, month, 1);
      var startDay = firstDay.getDay(); // в JS воскресенье=0
      if (startDay === 0) startDay = 7; // сдвигаем, чтобы понедельник=1
      ...
      var _loop = function _loop() {
        ...
        // Не даём выбрать даты в прошлом (пример)
        var now = new Date();
        ...
        if (cellDate < now) {
          ...
          dayCell.addEventListener('click', function () {
            ...
            selectedDateDiv.textContent = "\u0412\u044B \u0432\u044B\u0431\u0440\u0430\u043B\u0438: ".concat(cellDate.toLocaleDateString('ru'));
          });
        }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   priceButtons: function() { return /* binding */ priceButtons; }
/* harmony export */ });
var priceButtons = function priceButtons() {
  document.querySelectorAll('.price__min').forEach(function (list, index) {
    var button = list.nextElementSibling;
    if (!button || !button.classList.contains('price__min-link')) return;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   revOpen: function() { return /* binding */ revOpen; }
/* harmony export */ });
var revOpen = function revOpen() {
  document.querySelectorAll('.reviews-block__btn').forEach(function (btn) {
    btn.addEventListener('click', function () {
      var textBlock = this.previousElementSibling;
      var imageBlock = this.closest('.reviews-block__card-info--image');
      ...
      if (imageBlock) {
        ...
        if (image.classList.contains('expanded')) {
          imageBlock.scrollIntoView({
            behavior: 'smooth',
            block: 'nearest'
          });
        }
      }
      var isExpanded = textBlock && textBlock.classList.contains('expanded') || imageBlock && imageBlock.querySelector('img').classList.contains('expanded');
...
/* harmony import */ var _modules_init_dar__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./modules/init-dar */ "./js/modules/init-dar.js");
/* harmony import */ var _modules_init_accord__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./modules/init-accord */ "./js/modules/init-accord.js");
/* harmony import */ var _modules_price_button__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./modules/price-button */ "./js/modules/price-button.js");
/* harmony import */ var _modules_rev_open__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./modules/rev-open */ "./js/modules/rev-open.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0,_modules_init_dar__WEBPACK_IMPORTED_MODULE_20__.initDare)();
    (0,_modules_init_accord__WEBPACK_IMPORTED_MODULE_21__.initAccord)();
    (0,_modules_price_button__WEBPACK_IMPORTED_MODULE_22__.priceButtons)();
    (0,_modules_rev_open__WEBPACK_IMPORTED_MODULE_23__.revOpen)();
  });
});
}();
/******/ })()
